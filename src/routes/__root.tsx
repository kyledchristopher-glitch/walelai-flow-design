  ...
  head: () => ({
    meta: [
      ...
      { title: "WalelAI — AI Systems That Make Your Business Run Better" },
      {
        name: "description",
        content:
          "WalelAI helps organizations automate workflows, improve operations, and deploy practical AI systems that reduce manual work and increase productivity.",
      },
    ...
    links: [
      ...
      { rel: "icon", type: "image/png", href: "/walelai-icon.png" },
      { rel: "apple-touch-icon", href: "/walelai-icon.png" },
